package com.towhid.pointOfSale.sequrity;

import com.towhid.pointOfSale.jwt.JwtAuthenticationFilter;
import com.towhid.pointOfSale.service.UserService;
...
public class SequrityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:4200", "http://localhost:8801"));  // Add allowed origins
